    ...
    <Dialog open={open} onClose={onClose}>
      ...
      <DialogContent>
        ...
        <Stack spacing={1}>
          ...
          >
            {isLengthValid && (
              <Icon icon="line-md:clipboard-check" color={isLengthValid ? 'green' : 'red'} />
            )}{' '}
            Có ít nhất 8 ký tự
          </Typography>
          <Typography
          ...
          >
            {isUpperCaseValid && (
              <Icon icon="line-md:clipboard-check" color={isUpperCaseValid ? 'green' : 'red'} />
            )}{' '}
          ...
          >
            {isLowerCaseValid && (
              <Icon icon="line-md:clipboard-check" color={isLowerCaseValid ? 'green' : 'red'} />
            )}{' '}
            Có ít nhất một ký tự viết thường
          </Typography>
          <Typography display="flex" alignItems="center" color={isDigitValid ? 'success' : 'error'}>
            {isDigitValid && (
              <Icon icon="line-md:clipboard-check" color={isDigitValid ? 'green' : 'red'} />
            )}{' '}
        ...
        <Stack>
          <Typography display="flex" alignItems="center" color={isMatch ? 'success' : 'error'}>
            {isMatch && <Icon icon="line-md:clipboard-check" color={isMatch ? 'green' : 'red'} />}{' '}
      ...
      <DialogActions>
        ...
        <Button
          ...
          disabled={
            !isLengthValid || !isUpperCaseValid || !isDigitValid || !isSpecialCharValid || !isMatch
          }
        >
          Xác nhận
        </Button>
